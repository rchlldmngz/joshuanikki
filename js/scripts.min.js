$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event Address
            address: 'ST. BENEDICT PARISH, Silang Ca',
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $.post('https://script.google.com/macros/s/AKfycbyysgw3FveTL88ccUS8_EqLlzbUuXtnQRpn5KUPa_I11F99_vh6b3_jBa4CeeX2m0Pn/exec', data)
            .done(function (data) {
                console.log(data);
